...
ROOT_PROTO_DIR="./proto/cosmos"
COSMOS_PROTO_DIR="$ROOT_PROTO_DIR/cosmos-sdk/proto"
THIRD_PARTY_PROTO_DIR="$ROOT_PROTO_DIR/cosmos-sdk/third_party/proto"
OUT_DIR="./src/codec/"
...
protoc \
  ...
  "$ROOT_PROTO_DIR/ibc/core/channel/v1/channel.proto" \
  "$ROOT_PROTO_DIR/ibc/core/channel/v1/query.proto" \
  "$ROOT_PROTO_DIR/ibc/core/channel/v1/tx.proto" \
  "$ROOT_PROTO_DIR/ibc/core/client/v1/client.proto" \
  "$ROOT_PROTO_DIR/ibc/core/client/v1/query.proto" \
  "$ROOT_PROTO_DIR/ibc/core/client/v1/tx.proto" \
  "$ROOT_PROTO_DIR/ibc/core/commitment/v1/commitment.proto" \
